    ...
    <main className="min-h-screen bg-ink font-display text-paper antialiased selection:bg-neon selection:text-ink">
      ...
      <section id="path" className="scroll-mt-16 border-t border-line">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-14"><p className="mb-5 font-mono text-[11px] uppercase text-violet">Certifications</p><div className="grid gap-4 sm:grid-cols-2"><Certificate title="1M1B Green Internship" issuer="1M1B Green Skills Academy · AICTE & Salesforce" /><Certificate title="AI Skills Passport" issuer="EY & Microsoft" /></div></div>
        </div>
      </section>
...
function Certificate({ title, issuer }: { title: string; issuer: string }) { return <div className="rounded-lg border border-line bg-ink-2 p-5"><p className="font-mono text-xs text-mute">2025</p><h3 className="mt-1 text-lg font-semibold">{title}</h3><p className="mt-1 font-mono text-xs text-violet">{issuer}</p></div>; }
